...
const contourBoundsSchema = z.object({
  minX: finiteNumber,
  minY: finiteNumber,
  maxX: finiteNumber,
  maxY: finiteNumber,
...
const contourFrameSchema = z.object({
  kind: z.enum([
  ...
  authoritativeForBodyCutoutQa: z.boolean(),
  authoritativeForPrintableBand: z.boolean(),
  sourceCoordinateSpace: z.enum(["raw-image-px", "svg-px", "model-mm", "unknown"]),
  boundsBeforeBandCrop: contourBoundsSchema.nullable().optional(),
  boundsAfterBandCrop: contourBoundsSchema.nullable().optional(),
  bandCropApplied: z.boolean(),
  bandCropReason: z.string().optional(),
  bodyOnlyReCropSkipped: z.boolean(),
  acceptedPreviewBounds: contourBoundsSchema.nullable().optional(),
  glbInputBounds: contourBoundsSchema.nullable().optional(),
  canonicalInputBounds: contourBoundsSchema.nullable().optional(),
  croppedAwayTopUnits: finiteNumber.optional(),
  croppedAwayBottomUnits: finiteNumber.optional(),
  croppedAwayTopMm: finiteNumber.optional(),
  croppedAwayBottomMm: finiteNumber.optional(),
  sourceDiameterUnits: finiteNumber.optional(),
  mmPerSourceUnit: finiteNumber.optional(),
}).passthrough();

const bodyHeightAuthorityInputHeightsSchema = z.object({
  lookupFullProductHeightMm: finiteNumber.optional(),
  lookupBodyHeightMm: finiteNumber.optional(),
  templateDimensionsHeightMm: finiteNumber.optional(),
  templateDimensionsPrintHeightMm: finiteNumber.optional(),
  printableHeightMm: finiteNumber.optional(),
  engravableHeightMm: finiteNumber.optional(),
  approvedSvgBoundsHeightMm: finiteNumber.optional(),
  v2ProfileBoundsHeightMm: finiteNumber.optional(),
  referenceBandHeightPx: finiteNumber.optional(),
  generatedBodyBoundsHeightMm: finiteNumber.optional(),
  canonicalBodyHeightMm: finiteNumber.optional(),
  bodyTopFromOverallMm: finiteNumber.optional(),
  bodyBottomFromOverallMm: finiteNumber.optional(),
}).passthrough();

const bodyHeightAuthoritySchema = z.object({
  ...
  valueMm: finiteNumber.optional(),
  sourceField: z.string().optional(),
  sourceFunction: z.string().optional(),
  confidence: z.enum(["high", "medium", "low", "unknown"]),
  isFallback: z.boolean(),
  isPrintableHeight: z.boolean(),
  isPhysicalBodyHeight: z.boolean(),
  isFullProductHeight: z.boolean(),
  warnings: z.array(z.string()),
  errors: z.array(z.string()),
  inputHeights: bodyHeightAuthorityInputHeightsSchema,
  selectedScaleAuthority: z.object({
    diameterAuthority: z.string().optional(),
    heightAuthority: z.enum([
      "derived-from-diameter-scale",
      "manual-override",
      "ambiguous",
      "lookup-physical-body-height",
    ...
    yScaleSource: z.string().optional(),
    radialScaleSource: z.string().optional(),
  }).passthrough(),
  diameterAuthority: z.object({
    kind: z.string(),
    valueMm: finiteNumber.optional(),
    sourceField: z.string().optional(),
  }).passthrough(),
  sourceDiameterUnits: finiteNumber.optional(),
  sourceContourHeightUnits: finiteNumber.optional(),
  mmPerSourceUnit: finiteNumber.optional(),
  uniformScaleApplied: z.boolean(),
  derivedBodyHeightMm: finiteNumber.optional(),
  rejectedHeightSources: z.array(z.string()),
  svgPhysicalMmTrusted: z.boolean(),
  svgToPhotoTransformPresent: z.boolean(),
}).passthrough();
...
export const bodyGeometryContractSchema = z.object({
  ...
  mode: z.string(),
  source: z.object({
    type: z.enum(["approved-svg", "body-reference-v2", "uploaded-svg", "generated", "fallback", "unknown"]),
    ...
    centerlineCaptured: z.boolean().optional(),
    ...
    contourFrame: contourFrameSchema.optional(),
  }),
  glb: z.object({
  ...
  dimensionsMm: z.object({
    ...
    bodyHeightAuthority: bodyHeightAuthoritySchema.optional(),
    ...
    scaleSource: z.enum(["svg-viewbox", "lookup-diameter", "physical-wrap", "mesh-bounds", "unknown"]).optional(),
  }),
  validation: z.object({
    status: z.enum(["pass", "warn", "fail", "unknown"]),
    errors: z.array(z.string()),
